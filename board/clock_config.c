...
outputs:
- {id: FREQME_reference_clock.outFreq, value: 96 MHz}
- {id: FREQME_target_clock.outFreq, value: 96 MHz}
- {id: FRO_12MHz_clock.outFreq, value: 12 MHz}
...
void BOARD_BootClockFROHF96M(void)
{
    ...
    SYSCON->CLOCK_CTRL |=
        SYSCON_CLOCK_CTRL_FRO1MHZ_UTICK_ENA_MASK | SYSCON_CLOCK_CTRL_FRO12MHZ_FREQM_ENA_MASK |
        SYSCON_CLOCK_CTRL_FRO_HF_FREQM_ENA_MASK; /* Enable FRO 1M, 12M and HF to frequency measure module */
    CLOCK_EnableClock(kCLOCK_InputMux);
    INPUTMUX->FREQMEAS_REF = INPUTMUX_FREQMEAS_REF_CLKIN(2);
    INPUTMUX->FREQMEAS_TAR = INPUTMUX_FREQMEAS_TAR_CLKIN(2);
...
- {id: CTIMER1_clock.outFreq, value: 750 kHz}
- {id: FREQME_reference_clock.outFreq, value: 96 MHz}
- {id: FREQME_target_clock.outFreq, value: 96 MHz}
- {id: FRO_12MHz_clock.outFreq, value: 12 MHz}
...
- {id: SYSCON.CTIMER1CLKDIV.scale, value: '128', locked: true}
- {id: SYSCON.CTIMER2CLKDIV.scale, value: '128', locked: true}
- {id: SYSCON.CTIMERCLKSEL0.sel, value: ANACTRL.fro_hf_clk}
- {id: SYSCON.CTIMERCLKSEL1.sel, value: ANACTRL.fro_hf_clk}
- {id: SYSCON.FCCLKDIV0.scale, value: '1', locked: true}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivCtimer1Clk, 128U, false);           /*!< Set CTIMER1CLKDIV divider to value 128 */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivFlexcom0Clk, 1U, false);           /*!< Set FCCLKDIV0 divider to value 1 */
